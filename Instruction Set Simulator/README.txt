...
Select run to run the program, or step, to step through the program

The speed of execution can be adjusted using the box in the lower left corner

The time refers to the time taken by the processor class, not the real time, limited by the speed option, useful for evaluating the simulators performance